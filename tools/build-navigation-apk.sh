...
out=$project_dir/build/gio-kit-navigation-phase1-release.apk
dest=/storage/emulated/0/Download/gio-kit-navigation-phase1-release.apk
...
"$gogio_bin" -target android -arch arm64 -appid app.giokit.navigationdemo \
	-name "Gio Kit Navigation" -version 0.1.0.1 -minsdk 24 -targetsdk 35 \
